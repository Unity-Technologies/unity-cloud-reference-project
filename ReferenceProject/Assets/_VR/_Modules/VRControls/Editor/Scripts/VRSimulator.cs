...
namespace Unity.ReferenceProject.VRControls.Editor
{
    public class VRSimulator : UnityEditor.Editor
    {
        ...
        {
            var prefab = AssetDatabase.LoadAssetAtPath("Assets/_VR/_Modules/VRControls/Runtime/Prefabs/XR Device Simulator.prefab", typeof(XRDeviceSimulator));
