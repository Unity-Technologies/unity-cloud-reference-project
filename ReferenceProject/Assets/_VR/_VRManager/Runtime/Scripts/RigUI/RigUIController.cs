...
namespace Unity.ReferenceProject.VRManager
{
    public interface IRigUIController
    {
        ...
        public PanelController DockButtonClicked(PanelController panelController, Transform dockPoint, Vector3 offset, WorldSpaceUIDocument.InitializeDocument onPanelBuilt = null);
    }
    ...
    public class RigUIController : MonoBehaviour, IRigUIController
    {
        ...
        public void InitMainBar(List<ActionButton> buttons)
        {
            ...
            m_RigUIBarPanel.WorldSpaceUIDocument.OnPanelBuilt += OnPanelBuilt;
        ...
        public PanelController DockButtonClicked(PanelController panelController, Transform dockPoint, Vector3 offset, WorldSpaceUIDocument.InitializeDocument onPanelBuilt = null)
        {
            ...
            else
            {
                ...
                floatingPanel.WorldSpaceUIDocument.OnPanelBuilt += onPanelBuilt;
