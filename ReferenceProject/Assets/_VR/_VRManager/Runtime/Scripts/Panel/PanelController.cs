    ...
    public class PanelController : MonoBehaviour
    {
        ...
        public VisualTreeAsset VisualTreeAsset
        {
            ...
            set
            {
                ...
                m_WorldSpaceUIDocument.VisualTreeAsset = m_VisualTreeAsset;
            }
        }
        ...
        {
            get => m_WorldSpaceUIDocument.PanelSize;
            set => m_WorldSpaceUIDocument.PanelSize = value;
        }

        public VisualElement Root { get; private set; }

        public WorldSpaceUIDocument WorldSpaceUIDocument => m_WorldSpaceUIDocument;
        ...
        void Awake()
        {
            ...
            m_WorldSpaceUIDocument.OnPanelBuilt += OnPanelBuilt;
        }
