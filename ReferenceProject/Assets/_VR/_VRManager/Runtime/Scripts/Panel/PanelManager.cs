...
namespace Unity.ReferenceProject.VRManager
{
    ...
    public class PanelManager : MonoBehaviour, IPanelManager
    {
        ...
        public T CreatePanel<T>(Vector2 size, VisualTreeAsset visualTree = null) where T : PanelController
        {
            ...
            {
                panel.WorldSpaceUIDocument.OpaqueMaterial = m_MaterialOpaque;
                panel.WorldSpaceUIDocument.TransparentMaterial = m_MaterialTransparent;
                panel.WorldSpaceUIDocument.PanelSettingsPrefab.themeStyleSheet = m_ThemeStyleSheet;
            ...
            {
                panel.WorldSpaceUIDocument.gameObject.SetActive(false);
            }
