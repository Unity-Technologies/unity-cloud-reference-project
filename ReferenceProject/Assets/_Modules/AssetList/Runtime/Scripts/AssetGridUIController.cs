...
namespace Unity.ReferenceProject.AssetList
{
    public class AssetGridUIController : MonoBehaviour
    {
        ...
        static readonly string k_ItemRoot = "GridItem";
        ...
        public async Task Populate(IAsyncEnumerable<IAsset> assets)
        {
            Clear();
            ...
            var itemsSource = new List<IAsset>();
            ...
            Utils.SetVisible(m_WarningMessageNoAssets, itemsSource.Count == 0);
        }
        ...
        void RefreshGridItem(VisualElement item, int i)
        {
            ...
            if (asset.PreviewFile != null)
            {
                ...
                _ = ThumbnailController.GetThumbnail(asset, m_GridItemSize, texture2D =>
                {
