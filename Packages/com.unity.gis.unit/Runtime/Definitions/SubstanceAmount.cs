...
{
    /// <summary>
    /// Quantity to measures the size a group of individual elementary entities.
    /// </summary>
    public class SubstanceAmount : UnitDef<SubstanceAmount>, ISubstanceAmount
    {
        /// <summary>
        ...
        public SubstanceAmount(UnitNaming naming, bool isAbstract = false) :
        ...
        /// </param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public SubstanceAmount(UnitNaming naming, Func<double, double> formula, bool isAbstract = false) : 
        ...
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public SubstanceAmount(UnitNaming naming, IUnitDef copy, bool isAbstract = false) : 
            base(naming, copy, isAbstract : isAbstract) { }

        /// <summary>
        /// Main <see cref="SubstanceAmount"/> constructor.
        /// </summary>
        /// <param name="naming">Naming definition of the <see cref="UnitDef{T}"/>.</param>
        /// <param name="formula">
        /// Method with one double parameter representing a <see cref="IUnitDef"/> value as the <see cref="UnitDef{T}.BaseUnitDef"/>
        ...
        /// </param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public SubstanceAmount(UnitNaming naming, IFormula formula, bool isAbstract = false) : 
            base(naming, formula, isAbstract : isAbstract) { }
    }
}
