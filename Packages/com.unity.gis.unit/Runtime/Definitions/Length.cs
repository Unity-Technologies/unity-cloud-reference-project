...
namespace Unity.Geospatial.Unit
{
    ...
    /// </summary>
    public class Length : UnitDef<Length>, ILength
    {
        /// <summary>
        ...
        public Length(UnitNaming naming, bool isAbstract = false) :
            base(naming, 1, 1, isAbstract) { }
        ...
        /// </param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public Length(UnitNaming naming, Func<double, double> formula, bool isAbstract = false) : 
            base(naming, formula, 1, 1, isAbstract) { }
        ...
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public Length(UnitNaming naming, IUnitDef copy, bool isAbstract = false) : 
            base(naming, copy, 1, 1, isAbstract) { }

        /// <summary>
        /// Main <see cref="Length"/> constructor.
        /// </summary>
        /// <param name="naming">Naming definition of the <see cref="UnitDef{T}"/>.</param>
        /// <param name="formula">
        /// Method with one double parameter representing a <see cref="IUnitDef"/> value as the <see cref="UnitDef{T}.BaseUnitDef"/>
        ...
        /// </param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public Length(UnitNaming naming, IFormula formula, bool isAbstract = false) : 
            base(naming, formula, 1, 1, isAbstract) { }
    }
}
