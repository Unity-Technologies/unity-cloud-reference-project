...
{
    /// <summary>
    /// Quantity of three-dimensional space enclosed bye a closed surface.
    /// This is the measurement of the cubic value of <see cref="Length"/>.
    /// </summary>
    public class Volume : UnitDefPower<Volume>, IVolume
    {
        /// <summary>
        ...
        public Volume(UnitNaming naming, bool hasSuperscript = false, bool isAbstract = false) :
            base(naming, 3, hasSuperscript, isAbstract) { }
        ...
        /// <param name="hasSuperscript">true if the superscript power is part of the string format; false otherwise.</param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public Volume(UnitNaming naming, Func<double, double> formula, bool hasSuperscript = false, bool isAbstract = false) : 
            base(naming, formula, 3, hasSuperscript, isAbstract) { }
        ...
        /// <param name="hasSuperscript">true if the superscript power is part of the string format; false otherwise.</param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public Volume(UnitNaming naming, IUnitDef copy, bool hasSuperscript = false, bool isAbstract = false) : 
            base(naming, copy, 3, hasSuperscript, isAbstract) { }

        /// <summary>
        /// Main <see cref="Volume"/> constructor.
        /// </summary>
        /// <param name="naming">Naming definition of the <see cref="UnitDef{T}"/>.</param>
        /// <param name="formula">
        /// Method with one double parameter representing a <see cref="IUnitDef"/> value as the <see cref="UnitDef{T}.BaseUnitDef"/>
        ...
        /// <param name="hasSuperscript">true if the superscript power is part of the string format; false otherwise.</param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public Volume(UnitNaming naming, IFormula formula, bool hasSuperscript = false, bool isAbstract = false) : 
            base(naming, formula, 3, hasSuperscript, isAbstract) { }
    }
}
