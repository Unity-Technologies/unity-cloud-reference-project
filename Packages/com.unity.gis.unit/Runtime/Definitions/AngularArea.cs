...
{
    /// <summary>
    /// Measure of the amount of the field of view from some particular point that a given object covers.
    /// </summary>
    public class AngularArea : UnitDefPower<AngularArea>, IAngularArea
    {
        /// <summary>
        ...
        public AngularArea(UnitNaming naming, bool hasSuperscript = false, bool isAbstract = false) :
        ...
        /// <param name="hasSuperscript">true if the superscript power is part of the string format; false otherwise.</param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public AngularArea(UnitNaming naming, Func<double, double> formula, bool hasSuperscript = false, bool isAbstract = false) : 
        ...
        /// <param name="hasSuperscript">true if the superscript power is part of the string format; false otherwise.</param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public AngularArea(UnitNaming naming, IUnitDef copy, bool hasSuperscript = false, bool isAbstract = false) : 
            base(naming, copy, 2, hasSuperscript, isAbstract) { }

        /// <summary>
        /// Main <see cref="AngularArea"/> constructor.
        /// </summary>
        /// <param name="naming">Naming definition of the <see cref="UnitDef{T}"/>.</param>
        /// <param name="formula">
        /// Method with one double parameter representing a <see cref="IUnitDef"/> value as the <see cref="UnitDef{T}.BaseUnitDef"/>
        ...
        /// <param name="hasSuperscript">true if the superscript power is part of the string format; false otherwise.</param>
        /// <param name="isAbstract">true if the unit represent a none defined unit which require external <see cref="UnitDef{T}.Scale"/> value to be converted; false otherwise.</param>
        public AngularArea(UnitNaming naming, IFormula formula, bool hasSuperscript = false, bool isAbstract = false) : 
            base(naming, formula, 2, hasSuperscript, isAbstract) { }
    }
}
