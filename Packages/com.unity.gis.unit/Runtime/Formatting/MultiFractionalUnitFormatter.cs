...
{
    public class MultiFractionalUnitFormatter : IUnitFormatter
    {
        /// <summary>
        ...
        /// into smaller units. Each value is formatted with <see cref="FractionalUnitFormatter"/>, and concatenated into the output string.
        /// </summary>
        ...
        public MultiFractionalUnitFormatter(IUnitDef[] units, bool dropZeroScales = true, bool fullStringFormat = false, bool hasSuperscript = false, int precision = 16, bool richText = false)
        {
            ...
            m_BaseFormatter = new FractionalUnitFormatter(fullStringFormat, hasSuperscript, precision, richText);
        }
